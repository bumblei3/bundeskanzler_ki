...
class ContextProcessor:
    ...
    def __init__(
        ...
        """
        self.memory = MemoryNetwork(memory_size=memory_size, key_dim=key_dim, num_heads=num_heads)
    ...
    def _calculate_importance(self, text: str, metadata: Optional[Dict] = None) -> tf.Tensor:
        """
