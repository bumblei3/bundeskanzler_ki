...
Bitte gib eine kohärente Antwort, die den bisherigen Kontext berücksichtigt:"""
    ...
    def _extract_topic(self, question: str) -> Optional[str]:
        ...
        topic_keywords = {
            ...
            'wirtschaft': ['wirtschaft', 'arbeit', 'unternehmen', 'mittelstand', 'export'],
    ...
    def fact_check_response(self, response: str, topic: Optional[str] = None) -> Dict[str, Any]:
        ...
        if not topic or topic not in self.fact_database:
            ...
            result['suggestions'].append("Antwort ohne spezifisches Thema - bitte Thema spezifizieren")
            return result
    ...
    def calculate_response_quality_score(self, response: str, question: str) -> Dict[str, Any]:
        ...
        if relevance_score > 0.3:
            ...
            quality_metrics['improvement_suggestions'].append("Antwort direkter auf die Frage beziehen")
        ...
        helpful_indicators = ['ich helfe', 'wir können', 'es gibt', 'möglich', 'empfehle']
        ...
        if helpful_score > 0:
            ...
            quality_metrics['improvement_suggestions'].append("Konkrete Handlungsempfehlungen hinzufügen")
        ...
        if fact_check['verified_facts']:
            quality_metrics['strengths'].append(f"{len(fact_check['verified_facts'])} Fakten verifiziert")
        if fact_check['suggestions']:
            quality_metrics['improvement_suggestions'].extend(fact_check['suggestions'])

        # Gesamt-Score berechnen
        weights = {'relevance': 0.25, 'accuracy': 0.3, 'completeness': 0.2, 'clarity': 0.15, 'helpfulness': 0.1}
    ...
    def enhance_response(self, response: str, question: str, context: Optional[Dict] = None) -> Dict[str, Any]:
        """
