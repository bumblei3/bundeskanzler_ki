...
def test_check_fact_basic():
    ...
    assert result.verification_status in ["verified", "partially_verified", "unverified", "contradicted"]
...
def test_check_fact_with_context():
    ...
    result = fc.check_fact("Deutschland hat sich zu Netto-Null-Emissionen bis 2045 verpflichtet.", context)
...
def test_bias_analysis():
    ...
    left_bias_result = fc.check_fact("Soziale Gerechtigkeit und Umweltschutz sind wichtiger als Wirtschaftswachstum.")
