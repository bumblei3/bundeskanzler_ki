...
keras_module.optimizers = type('Optimizers', (), {
    'Adam': _AdamOptimizer
})()
...
keras_module.callbacks = type('Callbacks', (), {
...
def test_get_training_callbacks_returns_list():
    callbacks = transformer_model.get_training_callbacks(model=None, config=tf_config.get_model_config())
