...
class PerformanceOptimizedKI:
    ...
    def _save_cache(self):
        ...
        try:
            ...
            logging.warning("Cache speichern fehlgeschlagen: %s", e)
    ...
    def _save_stats(self):
        ...
        try:
            ...
            logging.warning("Stats speichern fehlgeschlagen: %s", e)
    ...
    def antwort(self, frage: str) -> str:
        ...
        try:
            ...
            logging.warning("Invalid user input: %s", sanitize_log_message(str(e)))
            return "Entschuldigung, Ihre Eingabe enthält ungültige Zeichen oder ist zu lang."
        ...
        try:
            ...
            logging.error("Fehler bei Antwort-Generierung: %s", e)
