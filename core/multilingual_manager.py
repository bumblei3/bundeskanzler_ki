...
class ExtendedMultilingualManager:
    ...
    def __init__(self):
        ...
        logger.info(
            f"🌍 Extended MultilingualManager initialisiert - {len(self.supported_languages)} Sprachen unterstützt"
        )
    ...
    def translate_text(self, text: str, target_lang: Language) -> Optional[str]:
        ...
        logger.warning(
            f"🌍 Übersetzung nach {target_lang.value} nicht verfügbar - DeepL wurde entfernt"
        )
        return None
