...
class VerbesserteBundeskanzlerKI:
    ...
    def __init__(self):
        ...
        self.themen_keywords = {
            'klima': ['klima', 'klimaschutz', 'klimaneutralität', 'energie', 'erneuerbar', 'kohle', 'co2'],
            'wirtschaft': ['wirtschaft', 'industrie', 'mittelstand', 'start-up', 'innovation', 'ki', 'wasserstoff'],
        ...
        try:
            ...
            if thema_docs:
                ...
                if len(thema_docs) > 1 and konfidenz > 0.6:
                    zusatz_info = [doc['text'] for doc in thema_docs[1:3] if doc['score'] > 0.5]
                    if zusatz_info:
