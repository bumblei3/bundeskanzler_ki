...
class AdvancedMonitor:
    ...
    def _load_config(self):
        ...
        if config_file.exists():
            try:
                ...
                self.logger.info(f"Monitoring Konfiguration geladen: {len(self.alert_rules)} Alert Rules")
    ...
    def collect_system_metrics(self):
        ...
        try:
            ...
            self.add_metric('process_memory_mb', process.memory_info().rss / (1024**2), {'type': 'process'})
    ...
    def generate_health_check(self) -> Dict:
        ...
        try:
            ...
            # Application health
            recent_errors = len([e for e in self.metrics.get('request_success', []) 
            ...
            # Overall status
            all_checks_ok = all(
                check.get('cpu_ok', True) and 
                check.get('memory_ok', True) and 
                check.get('errors_ok', True) and 
                check.get('alerts_ok', True)
