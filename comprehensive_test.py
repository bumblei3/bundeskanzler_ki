...
def test_rtx2070_llm_manager():
    ...
    print("\n🧠 Test: RTX 2070 LLM Manager")
    try:
        from core.rtx2070_llm_manager import get_rtx2070_llm_manager, generate_llm_response
...
def main():
    ...
    for test_name, result in results.items():
        ...
        print(f"{status} {test_name.replace('_', ' ').title()}: {'Erfolgreich' if result else 'Fehlgeschlagen'}")
