...
class AdminCLI:
    ...
    def login(self, username="admin", password="admin123!"):
        """Admin-Login"""
        try:
            response = requests.post(f"{self.api_url}/auth/admin-token", 
    ...
    def system_status(self):
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                print(f"🔧 Components: {'✅ OK' if health['system']['components_initialized'] else '❌ Error'}")
    ...
    def view_logs(self, log_type="api.log", lines=10):
        ...
        try:
            resp = requests.get(f"{self.api_url}/admin/logs/{log_type}?lines={lines}", 
    ...
    def memory_stats(self):
        ...
        try:
            ...
            if resp.status_code == 200:
                stats = resp.json()
                print(f"📊 Kurzzeitgedächtnis: {stats.get('kurzzeitgedaechtnis_entries', 0)} Einträge")
                print(f"📊 Langzeitgedächtnis: {stats.get('langzeitgedaechtnis_entries', 0)} Einträge")
